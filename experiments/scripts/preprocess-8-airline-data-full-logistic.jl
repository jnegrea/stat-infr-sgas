...
output_path_8 = output_path*"experiments-8-airline-data-full/"
isdir(output_path_8) || mkdir(output_path_8)
...
airlineDataFull_compile_sizes(output_path_8*"airline-data-full", source_data_fname_prefix, years)
